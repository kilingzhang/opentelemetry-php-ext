...
PHP_INI_BEGIN()
        ...
        STD_PHP_INI_ENTRY("opentelemetry.grpc_max_queue_length", "2048", PHP_INI_PERDIR, OnUpdateLong, grpc_max_queue_length, zend_opentelemetry_globals, opentelemetry_globals)
