...
PHP_INI_BEGIN()
		...
		STD_PHP_INI_ENTRY("opentelemetry.enable_exception", "1", PHP_INI_PERDIR, OnUpdateBool, enable_exception, zend_opentelemetry_globals, opentelemetry_globals)
		STD_PHP_INI_ENTRY("opentelemetry.enable_error", "1", PHP_INI_PERDIR, OnUpdateBool, enable_error, zend_opentelemetry_globals, opentelemetry_globals)
		STD_PHP_INI_ENTRY("opentelemetry.enable_curl", "1", PHP_INI_PERDIR, OnUpdateBool, enable_curl, zend_opentelemetry_globals, opentelemetry_globals)
		STD_PHP_INI_ENTRY("opentelemetry.enable_memcached", "1", PHP_INI_PERDIR, OnUpdateBool, enable_memcached, zend_opentelemetry_globals, opentelemetry_globals)
		STD_PHP_INI_ENTRY("opentelemetry.enable_redis", "1", PHP_INI_PERDIR, OnUpdateBool, enable_redis, zend_opentelemetry_globals, opentelemetry_globals)
		STD_PHP_INI_ENTRY("opentelemetry.enable_mysql", "1", PHP_INI_PERDIR, OnUpdateBool, enable_mysql, zend_opentelemetry_globals, opentelemetry_globals)
		STD_PHP_INI_ENTRY("opentelemetry.enable_yar", "1", PHP_INI_PERDIR, OnUpdateBool, enable_yar, zend_opentelemetry_globals, opentelemetry_globals)
		STD_PHP_INI_ENTRY("opentelemetry.enable_collect", "1", PHP_INI_PERDIR, OnUpdateBool, enable_collect, zend_opentelemetry_globals, opentelemetry_globals)
		...
		STD_PHP_INI_ENTRY("opentelemetry.udp_look_up_time", PHP_OPENTELEMETRY_UDP_LOOK_UP_TIME, PHP_INI_PERDIR, OnUpdateLong, udp_look_up_time, zend_opentelemetry_globals, opentelemetry_globals)
